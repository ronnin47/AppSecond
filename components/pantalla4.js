...
export const Pantalla4=({navigation})=>{
       ...
       {/*<Text style={styles.titulo}>PANTALLA HOME</Text>*/}
        ...
        <View style={{flex:1, gap:12, marginTop:20, alignItems:"center"}}>
            ...
            onPress={()=>{navigation.navigate("Ejercicio16")}}>
                ...
                <Text style={styles.textBoton}>Ejercicio 16</Text>
            </TouchableOpacity>
            ...
            >
                <Text style={styles.textBoton}>Ejercicio 17</Text>
            </TouchableOpacity>
            ...
            >
                <Text style={styles.textBoton}>Ejercicio 18</Text>
            </TouchableOpacity>
