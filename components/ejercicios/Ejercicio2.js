...
const enunciado = "2) Hacer un programa que permita ingresar la altura y la base de un rectángulo, calcular su perímetro y mostrar el resultado por pantalla. ";

//FUNCION CALCULAR
const calcular = () => {
  const resultado = 2 * (Number(base) + Number(altura));
